...
public class AllStaticMessage {
	...
	// 登录
	public static String URL_Login = URL_Base + "/u.ashx?a=gfeng&m=checkShopUser&username=";// 1000&password=C001";
	...
	// 获取验证码
	public static String URL_GetCode = URL_Base + "/u.ashx?a=gfeng&m=getSafetyCode&tel=";// &getType= 1重置 2注册
	

	// 注册
	public static String URL_Register = URL_Base + "/u.ashx?a=gfeng&m=register&mobile=";// 18888888888&password=123456&sex=1&safetycode=123456

	// 获取个人资料
	public static String URL_Get_person_msg = URL_Base + "/u.ashx?a=gfeng&m=getUserInfo&userId=";// 1000

	// 更新个人信息
	public static String URL_Modify_person_msg = URL_Base + "/u.ashx?a=gfeng&m=changeUserInfo&userId=";// 1&birthday=2014-12-08&nickname=测试";

	// 修改密码
	public static String URL_Modify_Psd = URL_Base + "/u.ashx?a=gfeng&m=changePwd&userId=";// 1&newPassword=123&oldPassword=123456

	// 验证码校验
	public static String URL_Cheak_Code = URL_Base + "/u.ashx?m=getmcode&mobile=";// 1&mcode="

	// 密码重置
	public static String URL_ChongZhi_Psd = URL_Base + "/u.ashx?m=resetPwd&mobile=";// 1&newPwd=";

	// 首页
	public static String URL_Shouye_1 = URL_Base + "/p.ashx?a=gfeng&m=activelist&brandId=";//

	// 首页—分类
	public static String URL_Shouye_fenlei = URL_Base + "/p.ashx?m=brandlist&parentid=1";

	// 首页顶部图图片
	public static String URL_Shouye_DiBu = URL_Base + "/s.ashx?m=ad";

	// 分类
	public static String URL_FenLei = URL_Base + "/p.ashx?m=catelist&parentid=0";

	// 分类列表
	public static String URL_GetList_FenLei = URL_Base + "/p.ashx?m=getCateProduct&pageSize=30&pageNum=";// 1&id=1";
	...
	// 商品列表
	public static String URL_Goods_List = URL_Base + "/p.ashx?m=getProductList&id=";// 11&sort= 0 默认 | 1 最新 | 2 热销 | 3
												// 价格升序 | 4 价格降序

	// 商品详情
	public static String URL_Goods_detail = URL_GBase + "/wap/productdetail.html?a=";// pid=";//1&id=";

	public static String URL_Goods_detail_share = URL_GBase + "/wap/productdetail-wx.html?a=";// pid=";//1&id=";
	// 品牌专店
	public static String URL_PinPai = URL_Base + "/p.ashx?m=getBrandProduct&id=";// 12&pageNum=1";
	 ...
	 **/
	// 获取优惠券
	public static String URL_GetQuan = URL_Base + "/p.ashx?m=getCoupon&a=";// 1&userId=1&cid=1   品牌id，用户id  优惠券id//a=0  领取官方优惠券
	// 优惠券列表
	public static String URL_Quan_list = URL_Base + "/p.ashx?m=getUserCoupon&uid=";// &type=0未使用 1已使用 2已过期

	// 购物车
	public static String URL_ShoppingCar = URL_GBase + "/wap/car.html?";
	// 添加购物车
	public static String URL_Add_ShoppingCar = URL_Base + "/o.ashx?m=addlist&count=1&mobileType=3&pid=";// 1&spid=4&UserId=1&udid=123";
	// 商品id 规格 应用类型 机器号

	// 获取购物车商品数量
	public static String URL_GetShoppingCarNum = URL_Base + "/o.ashx?m=getCartCount&UserId=";// 1&udid=";

	// 地址列表
	public static String URL_Get_AddressList = URL_Base + "/o.ashx?m=getAddress&UserId=";

	// 删除单个地址
	public static String URL_Delete_Address = URL_Base + "/o.ashx?m=delAddress&UserId=";// 1&addressId=1

	// 新建收货地址
	public static String URL_New_CreateAddress = URL_Base + "/o.ashx?m=setAddress&UserId=";
	...
	// 添加订单
	public static String URL_Add_Order = URL_Base + "/o.ashx?m=submitOrder&UserId=";
	...
	// 订单列表
	public static String URL_Order_List = URL_Base + "/o.ashx?m=orderList&UserId=";// 1&orderState=0 0或空，默认查全部 | 1:待付款
											// | 2：待发货 | 3：待收货 | 4：待评价

	// 订单详情
	public static String URL_Order_Deatil = URL_Base + "/o.ashx?m=orderDes&UserId=";// 1&orderId=1

	// 取消订单
	public static String URL_QuXiao_Order = URL_Base + "/o.ashx?m=orderCancel&UserId=";// 1&OrderId=";

	// 查询订单状态
	public static String URL_CheckOrderStatus = URL_Base + "/o.ashx?m=queryOrderStatue&UserId=";// 1&OrderId=";

	// 添加收藏
	public static String URL_AddTo_Save = URL_Base + "/o.ashx?m=favrite&UserId=";// 1&goodsId=1";

	// 收藏列表
	public static String URL_Save_List = URL_Base + "/o.ashx?m=favriteList&UserId=";// 1

	// 删除收藏
	public static String URL_Delete_Save = URL_Base + "/o.ashx?m=delFavrite&UserId=";// 1&favriteId=
	...
	// 版本更新
	public static String URL_Modify_Apk = URL_Base + "/home.ashx?m=updateVersion";
	...
	//官方优惠券
	public static String URL_Guan_Quan=URL_Base+"/p.ashx?m=getEnableCoupon&UserId=";   
	...
	// 微信支付
	public static String URL_Wx_pay = URL_GBase + "/pay/wxpay/WXPay_pay.aspx?body=";
}