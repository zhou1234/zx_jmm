package com.jifeng.pulltorefresh;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
     ...
     */
    Handler handler;
    public PullToRefreshBase(Context context,Handler handler) {
        super(context);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mHeaderLayout = createHeaderLoadingLayout(context, attrs,handler);
            ...
            if (absDiff > mTouchSlop || isPullRefreshing() || isPullLoading())  {
                ...
                if (isPullRefreshEnabled() && isReadyForPullDown()) {
                    ...
                    if (mIsHandledTouchEvent) {
                    	...
                    	handler.sendEmptyMessage(0x02);//拉下松开判断
                    }
     ...
     */
    protected LoadingLayout createHeaderLoadingLayout(Context context, AttributeSet attrs,Handler handler) {
        return new HeaderLoadingLayout(context,handler);
    }
    ...
    protected void pullHeaderLayout(float delta) {
        ...
        if (delta < 0 && (oldScrollY - delta) >= 0) {
        	handler.sendEmptyMessage(0x02);//隐藏下拉布局
            setScrollTo(0, 0);
            return;
        }
        ...
        handler.sendEmptyMessage(0x03);//显示下拉布局
    }
