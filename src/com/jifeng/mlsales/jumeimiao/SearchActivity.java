...
public class SearchActivity extends Activity {
		...
		public void handleMessage(Message msg) {
			...
			case 0x01:
				...
				Animation hyperspaceJumpAnimation = AnimationUtils
						.loadAnimation(SearchActivity.this, R.anim.puch_up_in);
	...
	String Id, Pid;
	private MyGoodsListAdapter1 mAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tasckActivity.pushActivity(SearchActivity.this);
	}
						...
						try {
							if (response.getString("Status").equals("true")) {
								...
								if (array != null && array.length() > 0) {
									...
									if (mAdapter == null) {
										mAdapter = new MyGoodsListAdapter1(
	...
	private void relise() {
		...
		pageNo = 1;
		listData = null;
		tasckActivity.popActivity(SearchActivity.this);
		tasckActivity = null;
		System.gc();
	}
