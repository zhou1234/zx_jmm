...
import com.jifeng.pulltorefresh.FooterLoadingLayout;
import com.jifeng.pulltorefresh.ILoadingLayout.State;
import com.jifeng.pulltorefresh.LoadingLayout;
...
/**
 * 这个类实现了GridView下拉刷新，上加载更多和滑到底部自动加�?
 * 
 * @since 2013-8-15
 */
public class PullToRefreshGridView extends PullToRefreshBase<GridView> implements OnScrollListener {
     ...
     */
    public PullToRefreshGridView(Context context,Handler handler) {
